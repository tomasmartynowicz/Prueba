...
class Menu(object):
    ...
    def __new__ (self):
      if not self._instance:
         ...
         self.pantalla=[Pantalla("Jump the Rock:",pygame.display.set_mode((1080,420)),'fondo.jpg',0,0,1080),
                        Pantalla("Jump the Rock",pygame.display.set_mode((1080,420)),'fondo6.png',0,0,1080,'piso.png'),
                        Pantalla("Jump the Rock",pygame.display.set_mode((1080,420)),'gameover.png',0,0,1080),
                        Pantalla("Jump the Rock",pygame.display.set_mode((1080,420)),'f_puntaje.png',0,0,1080),
                        Pantalla("Jump the Rock",pygame.display.set_mode((1080,420)),'intruc.jpg',0,0,1080)]
